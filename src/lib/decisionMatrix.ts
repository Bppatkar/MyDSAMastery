...
export const DECISION_RULES: DecisionRule[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    approach: 'l=0, r=n-1\nwhile l < r:\n  sum = arr[l] + arr[r]\n  if sum == target: return [l, r]\n  else if sum < target: l++  // chhota sum → left badhao\n  else: r--  // bada sum → right ghatao',
