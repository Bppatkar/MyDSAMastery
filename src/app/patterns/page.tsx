  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <div className="border-b border-[#1e1e2e] bg-[#0c0c15]">
        <div className="px-8 sm:px-12 py-8 max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <div>
              ...
              <p className="text-[#7a7a9a] text-sm max-w-lg">
                Master {TOTAL_PATTERNS} patterns that solve 90% of FAANG
                interview questions. {TOTAL_QUESTIONS} problems — easy to hard.
              </p>
            </div>
          ...
          <div className="flex items-center gap-2 mt-5 px-4 py-2.5 rounded-xl bg-emerald-500/6 border border-emerald-500/12 w-fit">
            ...
            <p className="text-sm text-[#7a7a9a]">
              <span className="text-emerald-400 font-medium">Tip:</span> Start
              with Sliding Window (#1) and follow the order for best results.
            </p>
          </div>
        </div>
      </div>
